...
import { DocumentRevision } from './DocumentRevision.component';
const routes: Routes = [
  { path: '', component: DocumentRevision, canDeactivate: [CanDeactivateGuardService], pathMatch:'prefix'}
]
@NgModule({
  declarations: [
    DocumentRevision
...
export class DocumentRevisionModule { }
