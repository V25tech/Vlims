...
import { NotificationConfiguration } from './NotificationConfiguration.component';
const routes: Routes = [
       {path:'', component:NotificationConfiguration, canDeactivate: [CanDeactivateGuardService], pathMatch:'prefix'}
]
@NgModule({
  declarations: [
