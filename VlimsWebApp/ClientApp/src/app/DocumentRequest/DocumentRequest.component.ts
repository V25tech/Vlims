...
declare var $: any;
@Component({
  selector: 'DocumentTemplateConfiguration',
  templateUrl: './DocumentTemplateConfiguration.component.html'
})
export class DocumentTemplateConfiguration implements OnInit, CanComponentDeactivate
{
