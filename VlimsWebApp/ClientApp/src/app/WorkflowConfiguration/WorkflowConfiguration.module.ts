...
import { WorkflowConfiguration } from './WorkflowConfiguration.component';
const routes: Routes = [
       {path:'', component:WorkflowConfiguration, canDeactivate: [CanDeactivateGuardService], pathMatch:'prefix'}
]
@NgModule({
  declarations: [
