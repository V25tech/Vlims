...
import { DashboardConfiguration } from './DashboardConfiguration.component';
const routes: Routes = [
       {path:'', component:DashboardConfiguration, canDeactivate: [CanDeactivateGuardService], pathMatch:'prefix'}
]
@NgModule({
  declarations: [
