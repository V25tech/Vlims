...
declare var $: any;
@Component({
  selector: 'DashboardConfiguration',
  templateUrl: './DashboardConfiguration.component.html'
})
export class DashboardConfiguration implements OnInit, CanComponentDeactivate
{
