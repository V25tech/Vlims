...
namespace PolicySummary.Sheet1.Data
{
    ...
    // Comment
    public class UserGroupConfigurationData : IUserGroupConfigurationData
    {
        
        private readonly DataAccessHelper dataAccessHelper;
        
        public UserGroupConfigurationData(DataAccessHelper dataAccessHelper)
        {
            this.dataAccessHelper = dataAccessHelper;
        }
        
        public DataSet GetAllUserGroupConfiguration(RequestContext requestContext)
        {
            try
            {
        ...
        public DataSet GetUserGroupConfigurationByUgcid(string ugcid)
        {
            try
            {
        ...
        public DataSet GetUserGroupConfigurationByUserManagementId(System.Int32? uMId)
        {
            try
            {
