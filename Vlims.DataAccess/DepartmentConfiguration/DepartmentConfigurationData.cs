...
namespace PolicySummary.Sheet1.Data
{
    ...
    // Comment
    public class DepartmentConfigurationData : IDepartmentConfigurationData
    {
        
        private readonly DataAccessHelper dataAccessHelper;
        
        public DepartmentConfigurationData(DataAccessHelper dataAccessHelper)
        {
            this.dataAccessHelper = dataAccessHelper;
        }
        
        public DataSet GetAllDepartmentConfiguration(RequestContext requestContext)
        {
            try
            {
        ...
        public DataSet GetDepartmentConfigurationByDPCFId(string dPCFId)
        {
            try
            {
        ...
        public DataSet GetDepartmentConfigurationByHierarchyManagementId(System.Int32? hMId)
        {
            try
            {
