...
namespace PolicySummary.Sheet1.Data
{
    ...
    // Comment
    public class UserConfigurationData : IUserConfigurationData
    {
        
        private readonly DataAccessHelper dataAccessHelper;
        
        public UserConfigurationData(DataAccessHelper dataAccessHelper)
        {
            this.dataAccessHelper = dataAccessHelper;
        }
        
        public DataSet GetAllUserConfiguration(RequestContext requestContext)
        {
            try
            {
        ...
        public DataSet GetUserConfigurationByUCFId(string uCFId)
        {
            try
            {
        ...
        public DataSet GetUserConfigurationByUserManagementId(System.Int32? uMId)
        {
            try
            {
