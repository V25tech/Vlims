...
namespace PolicySummary.Sheet1.Data
{
    ...
    // Comment
    public class UserManagementData : IUserManagementData
    {
        
        private readonly DataAccessHelper dataAccessHelper;
        
        public UserManagementData(DataAccessHelper dataAccessHelper)
        {
            this.dataAccessHelper = dataAccessHelper;
        }
        
        public DataSet GetAllUserManagement(RequestContext requestContext)
        {
            try
            {
        ...
        public DataSet GetUserManagementByUMId(string uMId)
        {
            try
            {
