...
namespace PolicySummary.Sheet1.Services
{
    ...
    public class noticationconfigurationService : InoticationconfigurationService
    {
        ...
        private readonly InoticationconfigurationData noticationconfigurationData;
        
        /// <summary>
        /// 
        /// </summary>
        /// <param name="noticationconfigurationData"></param>
        public noticationconfigurationService(InoticationconfigurationData noticationconfigurationData)
        {
            this.noticationconfigurationData = noticationconfigurationData;
        }
