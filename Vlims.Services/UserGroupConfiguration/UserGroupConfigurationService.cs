...
namespace PolicySummary.Sheet1.Services
{
    ...
    public class UserGroupConfigurationService : IUserGroupConfigurationService
    {
        ...
        private readonly IUserGroupConfigurationData userGroupConfigurationData;
        
        /// <summary>
        /// 
        /// </summary>
        /// <param name="userGroupConfigurationData"></param>
        public UserGroupConfigurationService(IUserGroupConfigurationData userGroupConfigurationData)
        {
            this.userGroupConfigurationData = userGroupConfigurationData;
        }
