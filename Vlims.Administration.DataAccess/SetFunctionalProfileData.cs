    ...
    public static class SetFunctionalProfileData
    {
        ...
        public static bool SaveSetFunctionalProfile(setfuctionalprofile setFunctionalProfile)
        {
            try
            {
                ...
                sqlparms.Add(new SqlParameter { DbType = DbType.Boolean, ParameterName = SetFunctionalProfileConstants.Security_Configurations, Value = setFunctionalProfile.securityMgmt });
