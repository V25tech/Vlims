  Create PROCEDURE [dbo].[USP_DocumentTemplateConfiguration_PSY_UPDATE_1] @DTID_PSY int, @DocumentMasterId_PSY NVarChar(50),
...
Status_PSY=@Status_PSY,Pages=@Pages WHERE  [DTID_PSY] = @DTID_PSY ; 
