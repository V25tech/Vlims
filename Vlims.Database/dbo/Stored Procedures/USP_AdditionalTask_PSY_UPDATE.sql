...
DECLARE @OLDPREPARATIONDOCTYPE NVARCHAR(200);SET @OLDPREPARATIONDOCTYPE=(SELECT TOP(1) documenttype_PSY FROM DocumentPreparation_PSY WHERE Refrence_PSY=@referenceId AND Status_PSY='APPROVED' ORDER BY DPNID_PSY DESC)
