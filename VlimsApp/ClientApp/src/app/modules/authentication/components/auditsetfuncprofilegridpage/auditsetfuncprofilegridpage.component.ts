...
@Component({
  selector: 'app-auditsetfuncprofilegridpage',
  templateUrl: './auditsetfuncprofilegridpage.component.html',
  styleUrls: ['./auditsetfuncprofilegridpage.component.scss']
})
export class AuditsetfuncprofilegridpageComponent {
  ...
  getauditmodule() {
    ...
    this.commonsvc.req.type="ProfileType"
