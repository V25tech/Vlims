...
@Component({
  selector: 'app-auditrolegridpage',
  templateUrl: './auditrolegridpage.component.html',
  styleUrls: ['./auditrolegridpage.component.scss']
})
export class AuditrolegridpageComponent {
...
this.setConfig();
  ...
  setConfig() {
    this.gridConfig.Config = {
      ...
      currentPage: 1,
      rowsPerPageOptions: [10, 20, 50],
      gridDisplayName: "Role List Audit Trails"
    }
  }
  getauditmodule() {
    this.loader.show();

    this.commonsvc.req.type="RoleType"
