...
@Component({
  ...
  templateUrl: './auditusermanagementgridpage.component.html',
  styleUrls: ['./auditusermanagementgridpage.component.scss']
})
export class AuditusermanagementgridpageComponent {
...
this.setConfig();
  ...
  setConfig() {
    this.gridConfig.Config = {
      ...
      currentPage: 1,
      rowsPerPageOptions: [10, 20, 50],
      gridDisplayName: "User Configuration List Audit Trails"
    }
  }
  getauditmodule() {
    this.loader.show();
