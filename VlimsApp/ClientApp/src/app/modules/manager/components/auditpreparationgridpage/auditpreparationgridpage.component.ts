...
@Component({
  selector: 'app-auditpreparationgridpage',
  templateUrl: './auditpreparationgridpage.component.html',
  styleUrls: ['./auditpreparationgridpage.component.scss']
})
export class AuditpreparationgridpageComponent {
  ...
  setHeaders() {
    this.gridConfig.Headers = [
      { Name: 'documentno', DisplayName: 'Document Number', width: 20, sort: false, isNavigation: true },
      { Name: 'documenttitle', DisplayName: 'Document Title', width: 25, sort: false, isNavigation: false },
      { Name: 'documenttype', DisplayName: 'Document Type', width: 20, sort: false, isNavigation: false },
