...
@Component({
  selector: 'app-auditeffectivegridpage',
  templateUrl: './auditeffectivegridpage.component.html',
  styleUrls: ['./auditeffectivegridpage.component.scss']
})
export class AuditeffectivegridpageComponent {
  ...
  setHeaders() {
    this.gridConfig.Headers = [
      { Name: 'DEID', DisplayName: 'Effective Id', width: 20, sort: false, isNavigation: true },
      { Name: 'documentno', DisplayName: 'Document Number', width: 25, sort: false, isNavigation: false },
  ...
  handleAction(event: any) {
    console.log(event);
    this.router.navigate(["./../auditeffectiveaddpage"], { queryParams: { DocumentName: event.route.entityObj.ReferenceId } });
   }
}
