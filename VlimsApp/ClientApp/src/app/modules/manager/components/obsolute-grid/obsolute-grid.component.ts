...
@Component({
  selector: 'app-obsolute-grid',
  templateUrl: './obsolute-grid.component.html',
  styleUrls: ['./obsolute-grid.component.scss']
})
export class ObsoluteGridComponent {
  ...
  getExistingDocuments() {
    try {
      ...
      this.existdocService.getAllDocumentsobsolete(this.commonsvc.req).subscribe((data: any) => {
