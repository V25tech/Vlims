...
export class AppintializorService {
  ...
  documentmasterUrl: string = "https://dmsmasterprod.azurewebsites.net/";
  documentmanagerUrl: string = "https://dmsdocmanagerprod.azurewebsites.net/";
  adminUrl: string = "https://dmsadminprod.azurewebsites.net/";
