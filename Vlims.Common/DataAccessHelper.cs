...
namespace Vlims.Common
{
    public static class dataAccessHelper
    {
        ...
        private static void CreateConnection()
        {
            ...
            _database = new Microsoft.Practices.EnterpriseLibrary.Data.Sql.SqlDatabase("Data Source=tcp:vlimsserver.database.windows.net,1433;Initial Catalog=DMS_ACCORD;User ID=dmsadmin;Password=Passw0rd@123;Pooling=true;Min Pool Size=0;Max Pool Size=1024");
